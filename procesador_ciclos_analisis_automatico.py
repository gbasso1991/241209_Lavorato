...
# pendiente_patron_Dy2O3 = ufloat(2.089470553242323e-14,2.419522898110445e-15) #Vsm/A - (N=5) descartada
...
if templog:
    ...
    ax[3].plot(np.arange(len(Mag_max)), Mag_max,'v-',label='M$_{max}$')
